...
<?php include "header.php"; ?>
  ...
  <p><strong style="color:orange">&raquo; เพิ่มข่าว</strong></p>

    
    <label for="name">ชื่อข่าว :</label><br />
	<input name="name"  type="text" class="form-control" id="name" placeholder="หัวข้อข่าว" /><br />
  ...
  ?>
    ...
    <p class="help-block">ระบบจะปรับความกว้างเป็น 600*310px อัตโนมัติ (ปรับขนาดมาพอดีจะสวยกว่าเยอะนะแจ๊ะ)</p><br />-->
